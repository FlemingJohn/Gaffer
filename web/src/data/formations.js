...
export const FORMATIONS = {
  ...
  '4-2-3-1': [
    ...
    { role: 'CB', line: 'def', x: 0.62, y: 0.17 },
    { role: 'RB', line: 'def', x: 0.85, y: 0.22 },
    { role: 'DM', line: 'mid', x: 0.38, y: 0.4 },
    { role: 'DM', line: 'mid', x: 0.62, y: 0.4 },
    { role: 'LW', line: 'fwd', x: 0.18, y: 0.63 },
    { role: 'AM', line: 'mid', x: 0.5, y: 0.6 },
    { role: 'RW', line: 'fwd', x: 0.82, y: 0.63 },
    { role: 'ST', line: 'fwd', x: 0.5, y: 0.85 },
  ],
  '4-1-4-1': [
    { role: 'GK', line: 'gk', x: 0.5, y: 0.05 },
    { role: 'LB', line: 'def', x: 0.15, y: 0.22 },
    ...
    { role: 'CB', line: 'def', x: 0.62, y: 0.17 },
    { role: 'RB', line: 'def', x: 0.85, y: 0.22 },
    { role: 'DM', line: 'mid', x: 0.5, y: 0.36 },
    { role: 'LM', line: 'mid', x: 0.15, y: 0.56 },
    { role: 'CM', line: 'mid', x: 0.38, y: 0.52 },
    { role: 'CM', line: 'mid', x: 0.62, y: 0.52 },
    { role: 'RM', line: 'mid', x: 0.85, y: 0.56 },
    { role: 'ST', line: 'fwd', x: 0.5, y: 0.84 },
  ],
  '3-4-3': [
    { role: 'GK', line: 'gk', x: 0.5, y: 0.05 },
    { role: 'CB', line: 'def', x: 0.3, y: 0.18 },
    { role: 'CB', line: 'def', x: 0.5, y: 0.15 },
    { role: 'CB', line: 'def', x: 0.7, y: 0.18 },
    { role: 'LM', line: 'mid', x: 0.12, y: 0.48 },
    { role: 'CM', line: 'mid', x: 0.4, y: 0.45 },
    { role: 'CM', line: 'mid', x: 0.6, y: 0.45 },
    { role: 'RM', line: 'mid', x: 0.88, y: 0.48 },
    { role: 'LW', line: 'fwd', x: 0.25, y: 0.78 },
    { role: 'ST', line: 'fwd', x: 0.5, y: 0.85 },
    { role: 'RW', line: 'fwd', x: 0.75, y: 0.78 },
  ],
  '5-3-2': [
    { role: 'GK', line: 'gk', x: 0.5, y: 0.05 },
    { role: 'LB', line: 'def', x: 0.1, y: 0.3 },
    { role: 'CB', line: 'def', x: 0.3, y: 0.16 },
    { role: 'CB', line: 'def', x: 0.5, y: 0.13 },
    { role: 'CB', line: 'def', x: 0.7, y: 0.16 },
    { role: 'RB', line: 'def', x: 0.9, y: 0.3 },
    { role: 'CM', line: 'mid', x: 0.3, y: 0.5 },
    { role: 'CM', line: 'mid', x: 0.5, y: 0.54 },
    { role: 'CM', line: 'mid', x: 0.7, y: 0.5 },
    { role: 'ST', line: 'fwd', x: 0.4, y: 0.84 },
    { role: 'ST', line: 'fwd', x: 0.6, y: 0.84 },
  ],
  '4-5-1': [
    { role: 'GK', line: 'gk', x: 0.5, y: 0.05 },
    { role: 'LB', line: 'def', x: 0.15, y: 0.22 },
    ...
    { role: 'CB', line: 'def', x: 0.62, y: 0.17 },
    { role: 'RB', line: 'def', x: 0.85, y: 0.22 },
    { role: 'LM', line: 'mid', x: 0.12, y: 0.5 },
    { role: 'CM', line: 'mid', x: 0.35, y: 0.46 },
    { role: 'CM', line: 'mid', x: 0.5, y: 0.5 },
    { role: 'CM', line: 'mid', x: 0.65, y: 0.46 },
    { role: 'RM', line: 'mid', x: 0.88, y: 0.5 },
    { role: 'ST', line: 'fwd', x: 0.5, y: 0.84 },
  ],
};
